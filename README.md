...
**Toolkit modulare e professionale QGIS per la progettazione di infrastrutture gas.**
...
* 🗺️ **Gestione Geometrie e Sezioni**: Workflow indipendente per il bootstrap dei progetti regolamenti, gestione e sincronizzazione incrementale di GeoPackage (`GPKG`).
...
* **QGIS**: Versione 3.0 o superiore (consigliate versioni LTR)
